...
\begin{frame}{}
	\begin{block}{SBT -- Scala build tool}
		\begin{itemize}
			...
			\item<8->scalac und scala funktionieren auch
		\end{itemize}
	\end{block}
...
\begin{frame}[fragile]{}
 \begin{block}{Funktional Länge einer Liste}
\scriptsize
	\onslide<2->
  \begin{lstlisting}
...
res1: Time = 06:15
\end{lstlisting}
\normalsize{\textbf{Impliziter primärer Konstruktor}}
	\end{block}
	\note{An implicit class is a class marked with the implicit keyword. This keyword makes the class’ primary constructor available for implicit conversions when the class is in scope.
	
	Einzelnes : geht in Scala leider nicht.
	}
\end{frame}
    ...
    \column{0.5\textwidth}
      ...
      \begin{block}{Weniger geeignet}
		\begin{itemize}
			...
			\item<12->Umstieg auf JVM notwendig (F\# oder Swift)
		\end{itemize}
	\end{block}
  \end{columns}
	\note{}
