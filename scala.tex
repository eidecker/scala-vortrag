\documentclass[14pt,aspectratio=169,trans]{beamer} %aspectratio=169 %aspectratio=43 % trans erzeugt Folien ohne Overlay
...
% Großer Text
\begin{frame}{}
	\Large\textbf{Mögliche Bedeutung}
	\note{}
\end{frame}

\begin{frame}{}
	\begin{block}{Prozessdefinition}
		\begin{itemize}
			\item<2->Start, Stop, Nachrichten, Zustand
			\item<3->Klingt verdächtig nach Prozessen
			\item<4->Nebenläufig, skalierbar, resilient
			\item<4->Mein Traum: Direkte Abbildung
			\item<5->Scheint machbar
		\end{itemize}
	\end{block}
	\note{}
\end{frame}
