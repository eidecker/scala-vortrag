...
\setbeameroption{show notes on second screen=bottom} % show notes on second screen=bottom % hide notes % show notes % show only notes
...
\end{frame}
\note{TODO: Was bedeutet das? Scala ist sehr flexibel. Es vereint sehr viele Konzepte und ist im API-Design sehr stark. So sollen unterschiedlichste Szenarien und Anforderungen bedient werden. Schauen wir, ob das Versprechen gehalten wird.}
...
\begin{frame}{}
	\begin{block}{Eigenschaften}
		\begin{itemize}
			...
			\item<7->Ausdrucksstark (APIs/DSLs schreiben)
  ...
  \begin{columns}[T,onlytextwidth]
    \column{0.5\textwidth}
      ...
      \begin{block}{Vorteile}
		\begin{itemize}
			\item<3->Für moderne Architekturen geeignet
    ...
    \column{0.5\textwidth}
      ...
      \begin{block}{Nachteile}
		\begin{itemize}
			...
			\item<11->Zahl an Entwicklungssklaven
