...
\begin{frame}{}
	\begin{block}{Über mich}
		\begin{itemize}
			\item<2->Sebastian Eidecker
			\item<3->Softwareentwickler
			\item<4->Java-geprägt
		\end{itemize}
	\end{block}
	\note{}
...
\subsection{Aktuelle Anforderungen}
...
\begin{frame}{}
	\begin{block}{Forderungen des Business}
...
\begin{frame}{}
	\only<1->{\Large \textbf{Und unsere Projekte?}}
...
\subsection{Überblick -- Immer noch kein Code}
...
% Todo
\begin{frame}{}
	\begin{block}{Continious Integration}
		\begin{itemize}
