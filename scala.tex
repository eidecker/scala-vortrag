...
\begin{frame}{}
	\only<1->{\Large \textbf{Wo stehen wir\only<2->{\alert{ im Wettbewerb}}?}}
\end{frame}
...
\begin[allowframebreaks]{frame}{}
	\begin{block}{Aktoren}
		\begin{itemize}
			...
			\item<3->Nebenläufige Berechnungen
			\item<4->Kommunikation ausschließlich über Nachrichten
			\framebreak
			\item<5->Elastizität und Resilienz
			\item<6->Einfaches Mapping auf Prozessdefinitionen
		\end{itemize}
	\end{block}
	\note{}
\end{frame}
